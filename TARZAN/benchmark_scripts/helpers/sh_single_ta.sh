...
if [[ "$#" -ne 6 ]]; then
    echo "Usage: $0 <executable_path> <root_directory> <num_runs> <output_directory> <output_filename> <timeout_seconds>"
    echo "Example: $0 ./flower /path/to/benchmarks 5 /path/to/output results 300"
