 ...
 */
inline void testMaler(const std::string &path)
{
    ...
    std::vector<std::optional<int>> goal(4);
    goal[0] = locationsToInt[0].at("End1");
    goal[1] = locationsToInt[1].at("End2");
    goal[2] = locationsToInt[2].at("End3");
    goal[3] = locationsToInt[3].at("End4");
...
int main(const int argc, char *argv[])
{
    ...
    // Query: E<> (job1.End1 && job2.End2 && job3.End3 && job4.End4)
    testMaler(path);
